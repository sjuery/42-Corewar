...
/*   Updated: 2018/03/05 13:19:00 by sjuery           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void convert_name(t_disassembler *st)
{
    int name_len;
	int i = 0;
...
static void convert_description(t_disassembler *st)
{
    int desc_len;
	int i = 0;
...
void		print_sp_nl(t_disassembler *st, int *y)
{
	if (*y % 2 == 0 && *y % 16)
...
void		break_shit_up(t_disassembler *st, int size, int res, int *y)
{
	int i;
	int byte;
...
void		print_header(t_disassembler *st, int *y)
{
	int i = 0;
	int j = 0;
...
void		print_parameters(t_disassembler *st, int i, int *y)
{
	int j;
	int res;
...
static void	set_label_addresses(t_disassembler *st)
{
	t_label_ref *tmp;
	t_label *tmp_label;
	int ref = 0;
